package com.cryingonion.instashop.instagram.utils;
...
import com.cryingonion.instashop.instagram.InstagramApplication;

public class ImageDownloader {
	
	public static final int THREADCOUNT = 8;
    public static final String IMG_PATH = "Android/data/"
	    + InstagramApplication.PACKAGE_NAME + "/images";
